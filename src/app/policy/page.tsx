...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <Container>
        <div className="pb-10 pt-32 md:pt-40 px-5">
          <h1 className="text-4xl font-bold mb-14 text-center">
            Privacy Policy
          </h1>
          <p>
            <p>
              This privacy policy applies to the The Final Testament app (hereby
              referred to as &quot;Application&quot;) for mobile devices that
              was created by T. Yashwanth Kumar (hereby referred to as
            ...
            <h2 className="text-2xl font-semibold py-5">Third Party Access</h2>
            <p>
              Only aggregated, anonymized data is periodically transmitted to
              external services to aid the Service Provider in improving the
              Application and their service. The Service Provider may share your
              information with third parties in the ways that are described in
              this privacy statement. The Service Provider may disclose User
            ...
            <h2 className="text-2xl font-semibold py-5">Opt-Out Rights</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold py-5">Data Retention Policy</h2>
            <p>
              ...
              jesuschristholyfamily3@gmail.com and they will respond in a
              reasonable time.
            </p>
            <h2 className="text-2xl font-semibold py-5">Children</h2>
            <p>
            ...
            <div>
              <p>
                ...
                (jesuschristholyfamily3@gmail.com) so that they will be able to
                take the necessary actions. You must also be at least 16 years
                of age to consent to the processing of your personally
                identifiable information in your country (in some countries we
                may allow your parent or guardian to do so on your behalf).
              </p>
            </div>
            <h2 className="text-2xl font-semibold py-5">Security</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold py-5">Changes</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold py-5">Your Consent</h2>
            <p>
              By using the Application, you are consenting to the processing of
              your information as set forth in this Privacy Policy now and as
              amended by us.
            </p>
            <h2 className="text-2xl font-semibold py-5">Contact Us</h2>
            <p>
              If you have any questions regarding privacy while using the
              Application, or have questions about the practices, please contact
              the Service Provider via email at
              jesuschristholyfamily3@gmail.com.
            </p>
          </p>
        </div>
      </Container>
