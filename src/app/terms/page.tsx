      ...
      <Container>
        <div className="pb-10 pt-32 md:pt-40 px-5">
          ...
          <div className="flex-auto ">
            <p>
            These terms and conditions apply to the The Final Testament app
            (hereby referred to as Application) for mobile devices that was
            created by T. Yashwanth Kumar (hereby referred to as &quot;Service
          ...
          <p>
            ...
            not functioning correctly or at all. Please be aware that the
            Service Provider does not assume responsibility for certain aspects.
          ...
          <h2 className="text-2xl font-semibold py-5">Changes to These Terms and Conditions</h2>
          <p>
          ...
          <p>
            ...
            at jesuschristholyfamily3@gmail.com.
          </p>
        </div>
      </Container>
    </>
